...
class UnitTest:
    ...
    def create_react_test_file(self, project_path: str, test_file_name: str, unit_test_content: str) -> str:
    ...
    async def create_unit_test(self, project_id: str, test_file_name: str, 
        ...
        if project_type == ProjectType.JAVA:
            ...
            test_file_path = self.create_react_test_file(project_path, test_file_name, unit_test_content)
        else:
